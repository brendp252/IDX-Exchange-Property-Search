    ...
    return (
        <>
            ...
            {isLightboxOpen ? (
                ...
                >
                    <img
                        className='property-detail-page__lightbox-img'
                ...
                <div className='property-detail-page'>
                    ...
                    <div className='property-detail-page__additional'>
                        ...
                        <div>Property Type: {property.L_Type_}</div>
                        <div>Built in {property.YearBuilt}</div>
                        <div>{property.StoriesTotal} stories</div>
                        <div>{property.L_Keyword5} garage spaces</div>
                        <div>
                            Listed By: {property.LA1_UserFirstName} {property.LA1_UserLastName} ({property.LO1_OrganizationName})
                        </div>
                    </div>
                        ...
                        {openHouses.length > 0 ? (
                            openHouses.map((openHouse, index) => {
                                ...
                                try {
                                    ...
                                    startTime = parsed.OH_StartTime || "";
                                    endTime = parsed.OH_EndTime || "";
                                }
                                catch (error) {
                                    remarks = "";
                                    date = "";
                                ...
                                return (
                                    <div key={index}>
                                        ...
                                        {remarks && <p><strong>Notes: </strong>{remarks}</p>}
                                    </div>
                                );
                            })
                        ) : (
